...
class App(tk.Tk):
    ...
    # --- DITAMBAHKAN SETELAH form_edit_mhs ---
    ...
    def act_add_buku(self):
        j = simpledialog.askstring("Input", "Judul Buku:")
        if j:
            p = simpledialog.askstring("Input", "Penulis:")
            s = simpledialog.askinteger("Input", "Stok:")
            r = simpledialog.askstring("Input", "Rak:")
            self.perpus.tambah_buku(j, p, s, r); self.save_data(); self.page_buku()
